...
The Climate Security Playbook is an unclassified guide for NATO defense analysts, researchers, and planners, produced under the NATO Climate Change and Security Centre of Excellence fellowship program. Rather than a climate scientist's guide to security implications, it offers a defense analyst's guide to climate methodology — aiming to make readers more sophisticated consumers and commissioners of climate research and, where needed, capable of conducting their own exploratory analyses. The playbook is organized around the IPCC vulnerability framework — exposure, sensitivity, and adaptive capacity — and grounds each concept in a running case study of how changing Arctic conditions affect military aircraft ground operations at Evenes Air Station, Norway. Along the way it provides a climate science primer, guidance on climate projection data and compound-hazard methods, and practical advice on when (and when not) to commission climate analyses. It is accompanied by an annotated bibliography and an interactive knowledge base designed to be queried by generative AI tools.
</details>
